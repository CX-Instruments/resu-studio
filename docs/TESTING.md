...
```powershell
New-Item -ItemType Directory "D:\resu-test\.agents\skills" -Force
Copy-Item -Recurse "D:\resu-plugin\skills\resu-studio" "D:\resu-test\.agents\skills\resu-studio"
Copy-Item "D:\resu-plugin\docs\review\sample-cv.md" "D:\resu-test\Alex Morgan CV.md"
Copy-Item "D:\resu-plugin\docs\review\sample-job-ad.md" "D:\resu-test\job ad.md"
```
...
**File > Open Folder**, choose `D:\resu-test`. Start your AI tool's chat in that window.
...
- [ ] **It asks where to keep your files before doing anything else.** It should offer
  `D:\resu-test\Resu - CV Builder` or a folder in your home folder.
...
- [ ] After you choose, `D:\resu-test\Resu - CV Builder` exists, with `1 About me`,
...
1. Delete the folder `D:\resu-test`.
2. Open `C:\Users\jenro\.resu-studio\locations.json` in VS Code and delete the entry for
   `d:\resu-test` (or leave it; it does nothing once the folder is gone).
